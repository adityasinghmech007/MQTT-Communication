    ...
    /* USER CODE BEGIN 3 */
	  ...
	  while(Inverter_receive_status!=HAL_OK){
		  HAL_UART_Transmit_IT(&huart4, txData, sizeof(txData));
	  	  Inverter_receive_status=HAL_UART_Receive(&huart4, data, 70,2000);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PWR_KEY_Pin|RESET_KEY_Pin, GPIO_PIN_RESET);
